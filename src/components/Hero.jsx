...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-20 text-white overflow-hidden bg-gradient-to-r from-[#0B1026] via-[#111827] to-[#1E1B4B]"
    >
      {/* Glow Effects */}
      ...
      <div className="flex md:hidden justify-center mb-8 z-10">
        <img
          src={profileImg}
          alt="Profile"
          className="w-40 h-40 object-cover rounded-full border-4 border-purple-400 shadow-[0_0_60px_rgba(168,85,247,0.8)]"
        />
      </div>
      ...
      <div className="hidden md:flex flex-1 z-10 justify-center">
        <img
          src={profileImg}
          alt="Profile"
